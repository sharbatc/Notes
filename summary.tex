...
\begin{itemize}
  ...
  \begin{itemize}
  	\item (Relational model) \textbf{Cardinality} is the number of rows (number of items)
	\item (Relational model) \textbf{Degree} or \textbf{Arity} is the number of columns (number of attributes)
  \end{itemize}
  \item 
\end{itemize}
