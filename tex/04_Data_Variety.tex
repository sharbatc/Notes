...
\centerline{
\subfigure[XML data \label{pic:xml_data}] {\includegraphics[width=5cm]{img/04/xml_data} }
\subfigure[XML schema\label{pic:xml_schema}] {\includegraphics[width=7cm]{img/04/xml_schema} } 
}
