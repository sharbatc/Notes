...
\centerline{
\subfigure[Probability density function] {\includegraphics[width=5.5cm]{img/05/gauss_density}}
\subfigure[Cumulative distribution function] {\includegraphics[width=5.5cm]{img/05/gauss_cumul}} 
}
\caption{\label{gauss} 
Gaussian distribution 
} 
\centerline{
\subfigure[Probability density function] {\includegraphics[width=5.5cm]{img/05/Poisson_pmf}}
\subfigure[Cumulative distribution function] {\includegraphics[width=5.5cm]{img/05/Poisson_cdf}} 
}
\caption{\label{poisson} 
Poisson distribution 
}
\centerline{
\subfigure[Probability density function] {\includegraphics[width=5.5cm]{img/05/exp_pmf}}
\subfigure[Cumulative distribution function] {\includegraphics[width=5.5cm]{img/05/exp_cdf}} 
}
\caption{\label{exp} 
Exponential distribution 
} 
\centerline{
\subfigure[Probability density function] {\includegraphics[width=5.5cm]{img/05/binomial_pmf}}
\subfigure[Cumulative distribution function] {\includegraphics[width=5.5cm]{img/05/binomial_cdf}} 
}
